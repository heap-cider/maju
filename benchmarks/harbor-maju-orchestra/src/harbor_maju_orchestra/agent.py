"""Harbor custom-agent entry point for Maju orchestration."""
...
class MajuOrchestraAgent(BaseAgent):
    """Coordinate an arbitrary manifest-defined team through a Maju trial."""
    ...
    def _build_runtime(
        ...
        maju_acp_binary: str,
        maju_agent_binary: str,
        maju_dev_mcp_binary: str,
        maju_cli_binary: str,
        relay_gateway: str,
        ...
        return MajuContainerRuntime(
            ...
            endpoints=endpoints,
            maju_acp_binary=maju_acp_binary,
            maju_agent_binary=maju_agent_binary,
            maju_dev_mcp_binary=maju_dev_mcp_binary,
            maju_cli_binary=maju_cli_binary,
    ...
    async def run(
        ...
        if self.provisioner is None or self.runtime is None:
            raise RuntimeError(
                "MajuOrchestraAgent requires provisioner and runtime integrations; "
        ...
        context.metadata = {
            **result.metadata,
            ...
            "maju_channel_id": handle.channel_id,
            "run_id": run_id,
            "trial_id": trial_id,
        }
