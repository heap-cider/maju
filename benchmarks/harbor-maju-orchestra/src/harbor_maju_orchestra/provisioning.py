"""Typed boundary between the Harbor adapter and Maju trial provisioning."""
...
class AgentCredential:
    """One trial-scoped Maju identity and attributed LLM credential."""
...
class DirectoryIdentity:
    """One public, benchmark-seeded identity discoverable through Maju."""
...
@dataclass(frozen=True, slots=True)
class TrialHandle:
    """Provisioned Maju resources owned by one Harbor trial."""
    ...
    user_relay_url: str = ""
    # Additive Maju-native task context. Directory entries contain no secrets.
    task_name: str = ""
...
class TrialProvisioner(Protocol):
    """Creates and tears down trial-isolated Maju resources synchronously."""
