...
//    Both MAJU_UPDATER_PUBLIC_KEY and MAJU_UPDATER_ENDPOINT are required -
...
const updaterPubkey = process.env.MAJU_UPDATER_PUBLIC_KEY;
const updaterEndpoint = process.env.MAJU_UPDATER_ENDPOINT;

const missing = [];
if (!updaterPubkey) missing.push("MAJU_UPDATER_PUBLIC_KEY");
if (!updaterEndpoint) missing.push("MAJU_UPDATER_ENDPOINT");
if (missing.length > 0) {
  console.error(
