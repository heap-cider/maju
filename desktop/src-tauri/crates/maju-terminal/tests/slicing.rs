...
//!
//! Mutation checks run the package, never a file: `cargo test -p maju-terminal`.
//!
...
fn ordinary_output_needs_no_second_call() {
    let mut term = terminal();
    let line = b"\x1b[1;32mmaju\x1b[0m substrate line of output 0123456789\r\n";
