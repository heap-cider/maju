...
use maju_terminal::{damage::Frame, Viewport};
use std::fmt;
...
impl FramePublisher {
    ...
    /// teardown, or explicit detach. The caller owns safe Maju focus recovery.
...
mod tests {
    use super::*;
    use maju_terminal::damage::{CursorFrame, RowFrame};
