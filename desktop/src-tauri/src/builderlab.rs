...
<head>
  ...
  <title>Maju authentication complete</title>
  <style>
    :root {
      color-scheme: light;
...
<body>
  <main>
    <svg class="bee" viewBox="0 0 466 309" role="img" aria-label="Maju">
      <defs>
        <mask id="bee-mask">
    ...
    <p>You can close this window and return to Maju.</p>
  </main>
</body>
</html>"#;
...
pub(crate) async fn get_builderlab_nostr_identity(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/maju/nostr-identities/current",
        serde_json::json!({}),
    )
    .await
}
...
pub(crate) async fn bind_builderlab_nostr_identity(
    ...
    let challenge_value = authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/maju/nostr-identities/challenge",
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/maju/nostr-identities/verify",
        serde_json::json!({
...
pub(crate) async fn delete_builderlab_nostr_identity(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/maju/nostr-identities/delete",
        serde_json::json!({}),
    )
    .await
}
...
pub(crate) async fn check_builderlab_community_name(
    ...
    authenticated_json(
        ...
        &session,
        reqwest::Method::POST,
        "/v1/maju/communities/availability",
...
mod tests {
    ...
    #[test]
    fn auth_complete_page_uses_maju_brand() {
        for expected in [
            "<title>Maju authentication complete</title>",
            "#d7d72e",
            "#231e1e",
    ...
    fn login_defaults_to_auth0_login() {
        ...
        assert_eq!(query.get("product").map(String::as_str), Some("maju"));
        assert_eq!(
