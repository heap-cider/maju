...
pub use inbound::{
    commit_inbound_tombstone_with_store, commit_inbound_with_store, inbound_event_outcome,
    retain_inbound_event, InboundOutcome,
};
...
pub fn retention_scope<R: tauri::Runtime>(
    app: &AppHandle<R>,
    relay_url: &str,
