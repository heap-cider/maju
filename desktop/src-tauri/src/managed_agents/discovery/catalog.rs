...
use super::runtime_metadata::{
    KnownAcpRuntime, GOOSE_EFFORT_NORMALIZATION, MAJU_AGENT_EFFORT_VALUES,
};
use super::{CLAUDE_CODE_AVATAR_URL, CODEX_AVATAR_URL, GOOSE_AVATAR_URL, MAJU_AGENT_AVATAR_URL};

pub(crate) const KNOWN_ACP_RUNTIMES: &[KnownAcpRuntime] = &[
    super::runtime_metadata::ANTIGRAVITY_RUNTIME,
    KnownAcpRuntime {
        id: "goose",
        label: "Goose",
        commands: &["goose"],
    ...
    KnownAcpRuntime {
        ...
        effort_normalization: None, // claude: canonical routes through MAJU_ACP_EFFORT_LEVEL (ACP startup)
        effort_accepted_values: None, // claude: adapter accepts any value over MAJU_ACP_EFFORT_LEVEL
    ...
    KnownAcpRuntime {
        ...
        supports_acp_native_config: false,
        thinking_env_var: None,
        effort_normalization: None, // codex: canonical routes through MAJU_ACP_EFFORT_LEVEL (ACP startup)
        effort_accepted_values: None, // codex: adapter accepts any value over MAJU_ACP_EFFORT_LEVEL
        max_tokens_env_var: None,
        context_limit_env_var: None,
        max_rounds_env_var: None,
        required_normalized_fields: &[],
    ...
    KnownAcpRuntime {
        ...
        effort_normalization: None, // maju-agent: per-model catalog; see getProviderEffortConfig() in TS
        effort_accepted_values: Some(MAJU_AGENT_EFFORT_VALUES), // maju-agent: parse_thinking_effort's accepted set
