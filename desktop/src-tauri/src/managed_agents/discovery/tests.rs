...
use super::{
    ...
    parse_semver_tag, record_agent_command, refresh_login_shell_path, remove_record_effort_aliases,
    try_record_agent_command, CLAUDE_CODE_AVATAR_URL, CODEX_AVATAR_URL, GOOSE_AVATAR_URL,
    MAJU_AGENT_AVATAR_URL,
};
#[cfg(unix)]
use super::{
