...
// (maju-relay/src/handlers/ingest.rs). Eva's channel-window surface reads that
...
//
// Transport auth: the test relay runs MAJU_REQUIRE_AUTH_TOKEN=false
...
//
// Canonical tag shapes (crates/maju-sdk/src/builders.rs thread_tags + ingest):
