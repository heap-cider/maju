 ...
 * relay-admin paths, but `maju-admin add-member` deliberately emits none
 * (`crates/maju-admin/src/main.rs:6-13`), and kind:8000 fan-out is pod-local
...
const JOIN_ALERT_STORAGE_PREFIX = "maju-community-join-seen.v1";
 ...
 * (a kind:13534 snapshot larger than `MAJU_MAX_FRAME_BYTES` never arrives).
 */
