...
export function CommunityRail({
  ...
  return (
    <nav
      ...
      className="relative z-0 flex w-14 shrink-0 flex-col items-center gap-2 overflow-y-auto bg-sidebar px-2.5 pb-5 pt-[calc(var(--maju-top-chrome-height,40px)+7px)]"
