...
const SIDEBAR_PROJECTS_FILTER_KEY = "maju.sidebar.projects.filter";
const SIDEBAR_PROJECTS_SORT_KEY = "maju.sidebar.projects.sort";
const SIDEBAR_PROJECTS_EXPANDED_KEY = "maju.sidebar.projects.expanded";
