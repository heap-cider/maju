 ...
 * `./modelCapabilities`; this module owns only the maju-agent env-var keys and
 * the runtime-id guard. Mirrors the `config.rs` ⇄ `model_capabilities.rs` seam
 * in `crates/maju-agent`, where effort resolution is delegated to the manifest.
 ...
 */
export const MAJU_AGENT_THINKING_EFFORT_VALUES = THINKING_EFFORT_VALUES;
