 ...
 * mirroring the Rust interpreter in `crates/maju-agent/src/model_capabilities.rs`
...
/** Valid thinking-effort values accepted by maju-agent (mirrors parse_thinking_effort in config.rs). */
