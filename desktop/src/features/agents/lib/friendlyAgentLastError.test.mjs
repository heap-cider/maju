...
test("maju-acp wrapped auth failure → denied copy", () => {
...
test("unwrapped maju-agent prefix → denied copy", () => {
  // maju-agent's AgentError::LlmAuth Display is "llm auth: <body>"; if the
...
test("code -32001 → Maju shared compute denied copy (structured path)", () => {
