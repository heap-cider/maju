...
const EMOJI_MART_SHADOW_CSS = `
  ...
  #root {
    ...
    --maju-emoji-picker-search-control-height: 48px;
    --sidebar-width: 0px;
    display: flex;
  ...
  .search input[type="search"] {
    border-radius: 12px;
    height: var(--maju-emoji-picker-search-control-height);
    padding-bottom: 0;
    padding-top: 0;
  }
  ...
  .search + .flex {
    border-radius: 12px;
    flex: 0 0 auto;
    height: var(--maju-emoji-picker-search-control-height) !important;
    margin-left: 8px;
    width: var(--maju-emoji-picker-search-control-height) !important;
  }
  ...
  .skin-tone-button {
    ...
    height: calc(var(--maju-emoji-picker-search-control-height) - 8px) !important;
    width: calc(var(--maju-emoji-picker-search-control-height) - 8px) !important;
  }
  ...
  React.useEffect(() => {
    const updateThemeVars = () => {
      ...
      setThemeVars({
        ...
        "--maju-emoji-picker-rgb-input": input ?? "47, 51, 68",
