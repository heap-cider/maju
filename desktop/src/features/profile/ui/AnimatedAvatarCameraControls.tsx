      ...
      <div className={cn("h-14 pt-2", compact && "flex justify-center")}>
        {onRetry ? (
          ...
          <Button
            ...
            className={cn(
              compact
                ? "h-[2.375rem] rounded-full bg-[rgb(var(--maju-onboarding-avatar-action-bg))] px-6 text-sm font-medium text-[rgb(var(--maju-onboarding-avatar-action-fg))] hover:bg-[color:rgb(var(--maju-onboarding-avatar-action-bg)_/_0.9)]"
                : "h-12 w-full rounded-xl",
            )}
