...
export function relayKlipyCapability(
  ...
  if (
    info.supported_extensions?.includes("maju-gif") === true &&
 ...
 * omitted until Maju has an explicit third-party ad surface.
 */
 ...
 * to the message body but deliberately omits an imeta tag, since Maju relays
