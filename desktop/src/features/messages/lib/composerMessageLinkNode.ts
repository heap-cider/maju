 ...
 *
 * The exact Maju/http matchers win first, so Maju links keep their canonical
...
export function registerComposerMessageLinkMarkdownIt(
  ...
  const ruleName = "maju_composer_message_link";
  const tokenType = "maju_composer_message_link";
