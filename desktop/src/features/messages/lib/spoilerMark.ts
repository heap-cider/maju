...
const SPOILER_MARKDOWN_RULE = "maju_spoiler";
const SPOILER_OPEN_TOKEN = "maju_spoiler_open";
const SPOILER_CLOSE_TOKEN = "maju_spoiler_close";
...
export function registerSpoilerMarkdownIt(
  ...
  md.renderer.rules[SPOILER_OPEN_TOKEN] = () =>
    '<span data-spoiler="" class="maju-spoiler">';
