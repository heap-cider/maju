...
const SPOILER_SELECTOR = ".maju-spoiler[data-spoiler]";
...
function mountComposerSpoilerParticles(
  ...
  overlayRoot.className = "maju-spoiler-composer-particles";
  ...
  const mountSpoiler = (spoiler: HTMLElement) => {
    ...
    canvas.className =
      "maju-spoiler__particles maju-spoiler__particles--composer";
