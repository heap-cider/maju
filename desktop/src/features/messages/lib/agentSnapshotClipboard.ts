...
const CLIPBOARD_ATTRIBUTE = "data-maju-agent-snapshot";
...
/** Build Maju-specific clipboard HTML with the raw URL as its visible link. */
...
/** Convert a Maju snapshot clipboard payload into one pending attachment. */
