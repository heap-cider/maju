...
export function MicControls({
  ...
  const chevronButtonClass = compact
    ? "maju-huddle-split-chevron group h-8 w-5 shrink-0 rounded-l-none rounded-r-md border-l border-sidebar-border/80 px-0.5 py-0 text-sidebar-foreground/70 !shadow-none hover:bg-sidebar-foreground/5 hover:text-sidebar-foreground/70"
    ...
    <Popover>
      <div className="relative flex items-center">
        ...
        <Button
          ...
          className={cn(
            splitIconButtonClass,
            ttsEnabled ? "maju-huddle-split-main" : mutedHuddleControlClass,
          )}
          onClick={onToggleTts}
          size="icon"
