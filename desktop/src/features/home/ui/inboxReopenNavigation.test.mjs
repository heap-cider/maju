...
registerHooks({
  resolve(specifier, context, nextResolve) {
    if (specifier === "@/features/messages/ui/MessageComposer") {
      return { shortCircuit: true, url: "maju-inbox-stub:MessageComposer" };
    }
    if (specifier === "@/features/settings/UpdateIndicator") {
      return { shortCircuit: true, url: "maju-inbox-stub:UpdateIndicator" };
    }
    return nextResolve(specifier, context);
  },
  load(url, context, nextLoad) {
    if (url === "maju-inbox-stub:MessageComposer") {
      return {
        format: "module",
        shortCircuit: true,
    ...
    if (url === "maju-inbox-stub:UpdateIndicator") {
