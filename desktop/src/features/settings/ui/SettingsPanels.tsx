...
import { isMajuTheme, useTheme } from "@/shared/theme/ThemeProvider";
import {
  LIGHT_THEMES,
  SYNTAX_THEMES,
...
function ThemeSettingsCard() {
  ...
  const majuThemeSelected = isMajuTheme(themeName);
  const accentPickerHidden = majuThemeSelected;
    ...
    <SystemPreferencePreviewFrame
      ...
      darkGradient={
        selectedPairedDarkTheme
          ? MAJU_GRADIENT_STOPS[selectedPairedDarkTheme]
          : undefined
      }
      darkVars={
        selectedPairedDarkTheme ? getVars(selectedPairedDarkTheme) : null
      }
      lightGradient={MAJU_GRADIENT_STOPS[selectedPairedTheme]}
      lightVars={getVars(selectedPairedTheme)}
    />
  ) : (
    <ThemePreviewFrame
      className="h-[112px] w-[168px] shrink-0"
      sidebarGradient={MAJU_GRADIENT_STOPS[selectedTheme]}
  ...
  return (
    ...
    >
      <SettingsSectionHeader
        title="Appearance"
        description="Choose how Maju looks and feels."
      />
      ...
      <SettingsOptionGroupList>
        ...
        >
          ...
          <SettingsOptionRow data-testid="theme-style-row">
            <div className="min-w-0">
              ...
              <p
                ...
                data-settings-subcopy
              >
                Choose the colors used throughout Maju.
              </p>
            </div>
            <button
          ...
          <GlassBackgroundSetting />
          {majuThemeSelected ? <ProminentActiveTabSetting /> : null}
        </SettingsOptionGroup>
