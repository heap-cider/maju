...
export function BackupStep({
  ...
  const storageDescription =
    identityStorage === "system-keyring"
      ? "Maju keeps your identity key in your system keychain. Your computer may ask for your password when Maju needs to read the key."
      : identityStorage === "local-file"
        ? "Your system keychain wasn’t available, so Maju keeps your identity key in a private file on this device."
        : "Maju keeps your identity key protected on this device. Make a separate backup in case you lose access.";
  const storageTitle =
    identityStorage === "system-keyring"
  ...
  const introStorageDescription =
    identityStorage === "system-keyring"
      ? "Maju keeps your identity key in your system keychain."
      : identityStorage === "local-file"
        ? "Maju keeps your identity key in a private file on this device because the system keychain wasn’t available."
      ...
      >
        <div className="flex w-full max-w-140 shrink-0 flex-col text-center">
          ...
          <p className="mt-5 text-sm leading-6 text-foreground/75">
            Your identity key works like a password for your Maju account. Keep
      ...
      {!created ? (
        ...
        >
          <div className="w-full">
            ...
            <p className="mx-auto mt-5 flex max-w-[440px] items-start justify-center gap-1.5 text-center text-xs leading-5 text-[var(--maju-onboarding-backup-ink)]">
