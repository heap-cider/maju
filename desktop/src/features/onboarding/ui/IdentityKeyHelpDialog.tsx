...
const IDENTITY_KEY_HELP_SEEN_STORAGE_KEY =
  "maju.machine-onboarding.identity-key-help-seen.v1";
...
export function IdentityKeyHelpDialog() {
  ...
  return (
    <Dialog>
      ...
      <DialogContent
        className="maju-onboarding-neutral-theme max-w-[47.5rem] -translate-y-5"
      ...
      >
        <div className="mx-auto w-full max-w-[35rem] py-14 text-left max-sm:py-6">
          ...
          <DialogDescription
            asChild
            className="mt-6 space-y-4 text-pretty text-base leading-7 text-[color:var(--maju-onboarding-backup-ink)]"
          >
            <div>
              <p>
                Maju uses an identity key instead of a traditional account. It’s
                created on your device and represents you whenever you use Maju.
              </p>
              <p>
                Your identity belongs to you, not Maju. There’s no password to
                reset, and Maju can’t recover your key if you lose it. Keep a
                backup somewhere safe and never share it. Anyone with your key
                can act as you.
              </p>
              <p>
                If you’re new to Maju, create a new identity key. If you already
