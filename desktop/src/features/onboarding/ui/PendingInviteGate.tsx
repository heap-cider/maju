...
export function PendingInviteGate() {
  ...
  return (
    <div
      className="maju-onboarding-neutral-theme maju-startup-shell fixed inset-0 z-50 flex items-center justify-center bg-background px-4 py-8 text-foreground"
