...
export function OnboardingSlideTransition({
  ...
  return (
    <div
      className={cn("maju-onboarding-slide w-full", containerClassName)}
      key={transitionKey}
      {...props}
    >
      <TransitionLine
...
function TransitionLine({
  ...
  return (
    <div
      className="maju-onboarding-transition-line flex w-full justify-center"
      data-onboarding-direction={direction}
      data-onboarding-effect={effect}
    >
      <div
        className={cn(
          "maju-onboarding-transition-content w-full",
          contentClassName,
        )}
      >
        {children}
