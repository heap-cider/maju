...
const STORAGE_KEY = "maju-community-onboarding-transaction.v1";
...
export function markCommunityOnboardingComplete(
  ...
  storage.setItem(
    `maju-community-onboarding-complete.v1:${encodeURIComponent(relayUrl)}:${pubkey}`,
    "true",
  );
  ...
  storage.setItem(`maju-onboarding-complete.v1:${pubkey}`, "true");
}
