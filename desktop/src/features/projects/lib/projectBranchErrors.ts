/**
 * Relay push-policy denial token for a repository with no `maju-channel`
 * binding. Declared in Rust as `maju-core::git_perms::
...
const NO_CHANNEL_BINDING_COPY =
  ...
  "maju repos bind --id <repo> --channel <channel-uuid>";
