/**
 * "Discussed in" channel discovery for Maju git entities.
 *
 * Chat messages that reference a PR, issue, or repository do so only through
 * `maju://` links in their *content* — they carry no entity tags (see
 ...
 * of the search text, and `maju://` links tokenize into their query-param
