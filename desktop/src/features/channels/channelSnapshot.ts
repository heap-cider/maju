...
const STORAGE_KEY_PREFIX = "maju-channels.v1";
...
/** Clears parsed snapshots when the active community boundary changes. */
export function resetChannelSnapshotCache(): void {
  parsedSnapshotCache.clear();
}
