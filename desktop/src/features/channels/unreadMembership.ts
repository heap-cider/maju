...
export const participationStore = makeRootIdStore(
  "maju-thread-participation.v1",
);
export const authoredStore = makeRootIdStore("maju-thread-authored.v1");
export const mentionedStore = makeRootIdStore("maju-thread-mentioned.v1");
export const mutedStore = makeRootIdStore("maju-thread-muted.v1");
