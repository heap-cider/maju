 ...
 *  tree transitively imports a .css file (MajuLogoAnimation.tsx →
 *  maju-logo-animation.css) and the test-loader has no CSS stub. The
...
// MajuLogoAnimation.tsx → maju-logo-animation.css). The test below verifies the
