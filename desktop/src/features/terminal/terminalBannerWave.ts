 ...
 * This SUPERSEDES the original directive: "slow waves of the maju theme colors
 * moving across the honeycomb lattice right to left, with a separate slow
 * color wave on the `maju term` going left to right". The wordmark half is
 ...
 *
 * Tyler, amendment (msg 4e7abbc8): "double the animation speed on the maju
 ...
 * maju-dark that seam measured 182.5 in sRGB distance (#3dcf55 against
 ...
 *
 * Measured on this box, maju-dark, median of 7: calling `bannerColor` per cell
