...
export const LOCAL_STORAGE_SWEEP_RULES: readonly LocalStorageSweepRule[] = [
  { keyPrefix: "maju-channel-messages.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "maju-channels.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "maju-observed-unread.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "maju-sidebar-skeleton-shape.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "maju-timeline-skeleton-shape.v1:", maxAgeMs: 14 * DAY_MS },
  { keyPrefix: "maju-user-labels.v1:", maxAgeMs: 14 * DAY_MS },
  // Do not add maju-self-profile.v1: here. It is the load-bearing offline
