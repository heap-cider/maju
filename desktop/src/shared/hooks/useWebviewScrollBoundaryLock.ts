...
const CONVERSATION_SCROLL_SELECTOR = "[data-maju-conversation-scroll]";
 ...
 *
 * Maju is laid out as fixed-height nested panes. On macOS, a wheel/trackpad
 ...
 * boundaries, only containers marked with `data-maju-conversation-scroll` are
