...
export const chromeCssVars = {
  topChromeHeight: "--maju-top-chrome-height",
  channelContentTopPadding: "--maju-channel-content-top-padding",
} as const;
...
export const topChromeBackdrop = {
  ...
  height: "h-(--maju-top-chrome-height,40px)",
  /** `after:` pseudo-element offset aligned to the bottom of top chrome. */
  dividerTop: "after:top-(--maju-top-chrome-height,40px)",
} as const;
...
export const channelChrome = {
  ...
  negativeMargin: "-mb-(--maju-channel-content-top-padding,5.75rem)",
} as const;
