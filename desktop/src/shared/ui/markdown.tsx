...
import { MajuInlineLink } from "./markdown/MajuLinkChip";
...
export function createMarkdownComponents(
  ...
  function MarkdownAnchor({
    ...
    // Intercept `maju://channel/<uuid>` and `maju://message?...` links so
    ...
    // `maju://pr|issue|repo?…` entity links navigate in-app; malformed ones
