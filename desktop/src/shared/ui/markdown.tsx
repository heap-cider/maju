...
export function createMarkdownComponents(
  ...
  function MarkdownAnchor({
    ...
    // Keep Maju channel/message navigation in-app.
    if (href) {
    ...
    // `maju://pr|issue|repo|project?…` entity links navigate in-app;
    ...
    if (href) {
      ...
      if (
        ...
        parseSupportedLinkPreview(href, relayOrigin)?.href.startsWith("maju://")
      )
        return entityAnchor;
    }
