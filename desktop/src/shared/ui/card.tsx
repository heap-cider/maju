...
export const TEXTURED_SURFACE_CLASS =
  "maju-card-textured relative isolate rounded-none border-0 bg-transparent p-[var(--maju-card-textured-safe-inset)] shadow-none";
...
export function texturedSurfaceClasses({
  ...
  return cn(
    ...
    tone === "dark" && "maju-card-textured-dark",
    size === "compact" && "maju-card-textured-compact",
  );
}
    ...
    return (
      <Comp
        ...
        className={cn(
          ...
          variant === "textured" &&
            textureTone === "dark" &&
            "maju-card-textured-dark",
          variant === "textured" &&
            textureSize === "compact" &&
            "maju-card-textured-compact",
        )}
        {...props}
      />
    );
