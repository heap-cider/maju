...
// which would break copy → paste → click for `maju://message?…` links
// end-to-end. We pass a custom `urlTransform` that delegates to the
// default for `maju://message` and legacy `maju://message` hrefs.
//
...
test("messageLinkUrlTransform: leaves non-message maju:// schemes to default", () => {
