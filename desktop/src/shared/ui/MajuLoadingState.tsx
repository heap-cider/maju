...
import MajuLogoAnimation from "@/shared/ui/maju-logo/MajuLogoAnimation";

/** Centered, low-emphasis loading state for page and panel fetches. */
export function MajuLoadingState({
  className,
  fill = false,
  label = "Loading",
}: {
  ...
  return (
    <div
      ...
      data-testid="maju-loading-state"
      role="status"
    >
      <MajuLogoAnimation
        ariaLabel={label}
        className="maju-logo--scale-pulse"
        fullScreen={false}
