...
function SidebarActionDescriptionText({
  ...
  if (shouldReduceMotion || !transition.isAnimating) {
    return (
      <span className="maju-sidebar-action-description">
        {transition.current}
      </span>
    );
  }
  ...
  return (
    <span className="maju-sidebar-action-description">
      ...
      <span aria-hidden className="maju-sidebar-action-description__motion">
        <span
          className="maju-sidebar-action-description__reel"
    ...
    >
      <button
        ...
        className={cn(
          ...
          isSuccess
            ? "maju-sidebar-action-card--success disabled:cursor-default disabled:opacity-100"
            : surface === "secondary"
      ...
      >
        ...
        <motion.span
          className={cn(
            ...
            isSuccess
              ? "maju-sidebar-action-card__success-icon"
