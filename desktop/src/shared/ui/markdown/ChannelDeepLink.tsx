...
function ResolvedAuthoredDeepLink({
  ...
  if (!openable) {
    return (
      <span className="font-medium text-current" data-maju-link={href}>
        {children}
      </span>
    );
  }
...
/**
 * Renders an intentionally-labeled `maju://channel|message` deep link through
 ...
 * (`maju://channel/...` and `maju://message?...`) share this decision so a
