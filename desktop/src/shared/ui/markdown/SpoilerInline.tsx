...
export function SpoilerInline({
  ...
  if (!interactive) {
    if (isBlock) {
      return (
        <div
          className="maju-spoiler maju-spoiler--block maju-spoiler--inert"
          data-revealed="false"
          data-spoiler=""
        >
          <SpoilerParticles active contentRef={contentRef} />
          <div className="maju-spoiler__content" ref={setContentElement}>
    ...
    return (
      <span
        className="maju-spoiler maju-spoiler--inert"
        data-revealed="false"
        data-spoiler=""
      >
        <SpoilerParticles active contentRef={contentRef} />
        <span className="maju-spoiler__content" ref={setContentElement}>
          <SpoilerHiddenContext.Provider value={true}>
            {children}
          </SpoilerHiddenContext.Provider>
        </span>
  ...
  if (isBlock) {
    return (
      <div
        {...revealProps}
        className="maju-spoiler maju-spoiler--block"
