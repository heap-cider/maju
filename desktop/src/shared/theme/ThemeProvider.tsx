...
export const GLASS_BACKGROUND_STORAGE_KEY = "maju-glass-background";
export const GLASS_OPACITY_STORAGE_KEY = "maju-glass-opacity";
export const PROMINENT_ACTIVE_TAB_STORAGE_KEY = "maju-prominent-active-tab";
...
/** Toggle the Maju-specific gradient marker independently from glass. */
...
export function ThemeProvider({
  ...
  // The stronger selected-row treatment belongs exclusively to Maju. Keep
  // the saved preference so it is restored when the user returns to Maju,
  // but remove the live marker for every other theme.
  useEffect(() => {
    setProminentActiveTabActive(
      prominentActiveTab && isMajuTheme(effectiveTheme),
    );
