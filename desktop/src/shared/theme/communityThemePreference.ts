...
const STORAGE_KEY_PREFIX = "maju-community-theme.v1";
const OUTBOX_KEY_PREFIX = "maju-community-theme-outbox.v1";
const MIGRATION_KEY_PREFIX = "maju-community-theme-migrated.v1";
