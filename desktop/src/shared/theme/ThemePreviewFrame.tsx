...
/**
 * Maju sidebar-gradient stop tokens, keyed by theme name. The actual custom
 ...
 */
export const MAJU_GRADIENT_STOPS: Record<
  string,
  { top: string; bottom: string }
> = {
  maju: {
    top: "var(--maju-gradient-light-top)",
    bottom: "var(--maju-gradient-light-bottom)",
  },
  "maju-dark": {
    top: "var(--maju-gradient-dark-top)",
    bottom: "var(--maju-gradient-dark-bottom)",
  },
};
...
function SystemPreferencePreviewSvg({
  ...
  const lightGradientId = `${clipBase}-maju-light`;
  const darkGradientId = `${clipBase}-maju-dark`;
