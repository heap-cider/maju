  ...
  return (
    <MainInsetProvider mainInsetRef={mainInsetRef}>
      <SidebarInset
        ...
        data-maju-content-surface={isHuddleRoom ? true : undefined}
        data-maju-content-unframed={isHuddleRoom ? true : undefined}
        data-maju-glass-inset
        data-maju-shadow-viewport
        style={chromeCssVarDefaults as React.CSSProperties}
      >
        {isHuddleRoom && !isHuddleRoomStarting ? <HuddleRoomHeader /> : null}
        <MajuTheme.ContentSurface terminal={terminal} unframed={isHuddleRoom}>
