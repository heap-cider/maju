...
--     (crates/maju-db/src/push.rs: accept_lease_event and replace_lease).
...
--   * Lock key domain 'maju_push_gate:' is distinct from the audit lock
--     ('maju_audit:') and both lease-address lock families.
