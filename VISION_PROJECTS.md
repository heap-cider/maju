...
Standard NIP-34 clients see a normal repo. gitworkshop.dev renders it. ngit-cli works with it. Maju clients read the `maju-` tags and wire up the channel and project UI. One event, two audiences, zero custom kinds.
