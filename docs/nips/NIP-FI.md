...
The relay maintains one [`IssuerRegistry`](../../crates/maju-auth/src/nip_fi/config.rs):
...
Special-Purpose address deny table is implemented; see `crates/maju-core/src/network.rs`.
