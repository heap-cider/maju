...
tags: [nostr, nip-rs, read-state, formal-model, maju]
status: active
created: 2026-07-16
---
...
(below): every context ID Maju actually generates (channel UUID,
...
**Cost:** zero bytes for every context ID Maju generates today (channel
...
">256-byte key drop hazard" section: Maju's own key shapes cannot
