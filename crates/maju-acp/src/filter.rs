...
///   `str_ends_with`, `str_len` (duplicated intentionally from maju-workflow).
...
/// `str_len` — duplicated from maju-workflow intentionally so this crate
/// has no runtime dependency on maju-workflow.
