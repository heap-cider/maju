#![deny(unsafe_code)]
#![warn(missing_docs)]
//! `maju-sdk` — typed Nostr event builders for Maju operations.
//!
//! # Mental Model
//!
//! ```text
...
/// Re-export kind constants so consumers don't need maju-core directly.
pub use maju_core::kind;
...
pub use maju_core::channel::canonical_channel_name;
/// Channel type.
pub use maju_core::channel::ChannelType as ChannelKind;
/// Channel visibility.
pub use maju_core::channel::ChannelVisibility as Visibility;
/// Member role.
pub use maju_core::channel::MemberRole;
