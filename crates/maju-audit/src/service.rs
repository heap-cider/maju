...
const AUDIT_LOCK_NAMESPACE: &str = "maju_audit:";
...
mod tests {
    ...
    async fn test_pool() -> Option<PgPool> {
        let url = std::env::var("DATABASE_URL")
            .unwrap_or_else(|_| "postgres://maju:maju_dev@localhost:5432/maju".into()); // sadscan:disable np.postgres.1 -- local test fixture
