...
//! # Run one binary, MAJU_HEALTH_PORT=8180 MAJU_METRICS_PORT=9202,
//! # MAJU_RECONCILE_CHANNELS=false, MAJU_GIT_CONFORMANCE_PROBE=false
//! ```
//!
//! Each test is `#[ignore]` so it only runs explicitly:
//! `cargo test -p maju-test-client --test nip42_host_binding_live -- --ignored --test-threads=1`
