...
//! (MAJU-SEC-007 class, reported 2026-07-27).
//!
...
//!   DATABASE_URL=postgres://maju:maju_dev@localhost:5432/maju_relay_admin_regression \
//!   cargo test -p maju-test-client --test regression_relay_admin_ban_gate \
//!     -- --ignored --nocapture
