...
//! Minimal NIP-01 WebSocket test client for the Maju relay.
...
use maju_ws_client::NostrWsConnection;
pub use maju_ws_client::{parse_relay_message, OkResponse, RelayMessage, WsClientError};

/// Errors returned by [`MajuTestClient`] operations.
#[derive(Debug, Error)]
...
/// WebSocket test client for integration testing against a running Maju relay.
pub struct MajuTestClient {
