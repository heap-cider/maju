...
//!
//! maju-agent asks the client to authorize every LLM-issued MCP tool call
//! *before* executing it; the client applies `MAJU_ACP_PERMISSION_POLICY` and
...
//!   (`MAJU_AGENT_MAX_PENDING_PERMISSIONS`) acquired *before* any correlation
