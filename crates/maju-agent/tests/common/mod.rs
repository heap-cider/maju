//! Shared subprocess test harness for the maju-agent ACP integration suites.
//!
...
//!
//! It drives a real `maju-agent` child over the ACP wire against a fake LLM
...
/// `session/request_permission` response. Mirrors maju-acp's answering side,
