...
//! [`MeshStreamFrame::Data`](maju_relay_mesh::MeshStreamFrame). Their layout is
...
/// [`MeshStreamFrame::Data`](maju_relay_mesh::MeshStreamFrame)`.payload`,
...
mod tests {
    ...
    use maju_relay_mesh::{BoxFuture, StreamRecvHalf, StreamSendHalf};
    ...
    impl RelayPeerTransport for NullTransport {
        ...
        fn set_inbound(&self, _handler: Box<dyn maju_relay_mesh::InboundHandler>) {}
    }
