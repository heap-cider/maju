...
//!
//! This is the *client leg* of the `MAJU_MESH_DEMO_ECHO` evidence run: the
...
//!
//! - Gated on **both** `MAJU_MESH_DEMO_ECHO=on` and mesh enabled; 404
...
use maju_relay_mesh::RelayPeerTransport;
