#![deny(unsafe_code)]
#![warn(missing_docs)]
//! NIP-01 WebSocket relay for Maju private team communication.
...
/// `docs/spec/MultiTenantRelay.tla` by the independent `maju-conformance`
/// checker.
pub mod conformance;
...
/// Workflow action sink — relay-side implementation of [`maju_workflow::ActionSink`].
