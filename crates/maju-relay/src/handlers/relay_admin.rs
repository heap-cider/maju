...
fn admits_relay_admin_command(
    restriction: &maju_db::moderation::RestrictionState,
...
mod postgres_tests {
    ...
    fn banned_actor_is_not_admitted_to_a_relay_admin_command() {
        let banned = maju_db::moderation::RestrictionState {
            banned: true,
            muted_until: None,
        };
        assert_eq!(
    ...
    fn timed_out_actor_is_still_admitted() {
        let timed_out = maju_db::moderation::RestrictionState {
            banned: false,
    ...
    fn unrestricted_actor_is_admitted() {
        assert!(
            admits_relay_admin_command(&maju_db::moderation::RestrictionState::default()).is_ok()
        );
    }
