...
//!
//! Crash report (2026-07-08, maju-desktop 0.3.46): enabling Share compute
...
//!
//!   cargo run -p maju-relay --example mesh_stack_smoke
...
/// Must match `maju_lib::mesh_llm::MESH_WORKER_STACK_SIZE` (desktop crate is
/// not a dependency of maju-relay, so the value is duplicated here).
