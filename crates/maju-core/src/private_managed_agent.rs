...
pub const FORMAT: &str = "maju-private-managed-agent";
...
mod tests {
    ...
    fn projection_hash_fixture_is_stable() {
        assert_eq!(
            content_sha256(b"maju-private-managed-agent-v1"),
            "fdbd9e3fd0a1659e67f70cf08a20e93d3771948e88c3929c1d1c00b9d8cdc140"
        );
    }
}
