...
```bash
tamarin-prover --prove crates/maju-core/src/pairing/NIP-AB.spthy
```
...
Implementations MUST validate against these vectors. They can be reproduced with `maju-pair test-vectors`.
