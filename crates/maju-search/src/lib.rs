#![deny(unsafe_code)]
#![warn(missing_docs)]
//! Maju search — community-scoped Postgres full-text search over Maju events.
//!
...
//! by `maju-db`. The relay refetches canonical events through `maju-db`'s
