...
//! `MAJU_MEDIA_UPLOAD_RECORDS`. IP collection is a second, independent opt-in
//! (`MAJU_MEDIA_UPLOAD_IP_HEADER`) and is *fail-empty*: a missing, malformed,
...
//!
//! ## Consumer contract (maju-moderation)
//!
...
pub struct UploadRecord {
    ...
    /// Present only when `MAJU_MEDIA_UPLOAD_IP_HEADER` is set AND the header
