...
pub fn sdk_err(e: maju_sdk::SdkError) -> CliError {
    match e {
        maju_sdk::SdkError::InvalidInput(msg) => CliError::Usage(msg),
...
mod tests {
    ...
    // and `normalize_mention_pubkeys` live in `maju_sdk::mentions` and are tested there.
