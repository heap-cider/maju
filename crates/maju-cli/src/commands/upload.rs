...
pub async fn dispatch(cmd: crate::UploadCmd, client: &MajuClient) -> Result<(), CliError> {
    match cmd {
...
pub async fn dispatch_media(cmd: crate::MediaCmd, client: &MajuClient) -> Result<(), CliError> {
    match cmd {
