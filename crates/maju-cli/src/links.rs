//! Canonical `maju://` deep links for Maju-hosted git entities.
//!
...
mod tests {
    ...
    fn golden_format_matches_desktop() {
        assert_eq!(
            pull_request_link(EVENT_ID, OWNER, "maju-world"),
            format!("maju://pr?id={EVENT_ID}&owner={OWNER}&d=maju-world")
        );
        assert_eq!(
            issue_link(EVENT_ID, OWNER, "maju-world"),
            format!("maju://issue?id={EVENT_ID}&owner={OWNER}&d=maju-world")
        );
        assert_eq!(
            repo_link(OWNER, "maju-world"),
            format!("maju://repo?owner={OWNER}&d=maju-world")
        );
    }
}
