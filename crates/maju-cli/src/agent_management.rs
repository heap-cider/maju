//! Owner-reviewed agent draft requests published through Maju observer frames.

use maju_core::observer::{encrypt_observer_payload, OBSERVER_FRAME_TELEMETRY};
...
fn build<T: Serialize>(
    ...
    let event = maju_sdk::build_agent_observer_frame(
        &owner.to_hex(),
...
mod tests {
    use super::*;
    use maju_core::observer::{decrypt_observer_payload, OBSERVER_AGENT_TAG, OBSERVER_FRAME_TAG};
