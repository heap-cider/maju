...
use maju_core::network::is_not_global_unicast;
...
/// Sealed injection seam for JWKS HTTP fetching. Only types inside `maju_auth`
...
///   `maju_core::network::is_not_global_unicast` before the request is sent;
