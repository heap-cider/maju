...
/// trace schema.
///
/// This deliberately does NOT reuse `maju_core::CommunityId`. Two reasons:
///
/// 1. **Production fence preservation.** `maju_core::CommunityId` has no
...
impl CommunityLabel {
    /// Wrap a UUID into a community label. Unlike `maju_core::CommunityId`
