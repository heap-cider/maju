//! Immutable capabilities for Maju Desktop's April Pocket TTS bundle.
...
/// Capabilities of Maju Desktop's sole Pocket model.
#[derive(Debug, Clone, Copy, PartialEq, Eq)]
...
/// Return immutable metadata for Maju Desktop's April INT8 model.
