...
pub const CACHE_INVALIDATION_PATTERN: &str = "maju:*:cache-invalidate";
...
pub fn cache_invalidation_channel(ctx: &TenantContext) -> String {
    format!(
        "{MAJU_PREFIX}:{}:{CACHE_INVALIDATION_SUFFIX}",
        ctx.community()
    )
}
...
/// Subscribes to `maju:*:cache-invalidate` and forwards scoped drops to the broadcast.
///
...
mod tests {
    ...
    fn cache_invalidation_channel_is_community_scoped() {
        ...
        assert_eq!(
            ...
            format!("maju:{}:cache-invalidate", community_a.community())
        );
        assert_ne!(
            cache_invalidation_channel(&community_a),
    ...
    fn parses_cache_invalidation_channel() {
        ...
        let raw = format!("maju:{community_id}:cache-invalidate");
    ...
    fn rejects_bad_cache_invalidation_channels() {
        for raw in [
            "maju:cache-invalidate",
            "maju:not-a-uuid:cache-invalidate",
            "not-maju:00000000-0000-0000-0000-00000000aaaa:cache-invalidate",
            "maju:00000000-0000-0000-0000-00000000aaaa:cache-invalidate:extra",
            "maju:00000000-0000-0000-0000-00000000aaaa:channel:00000000-0000-0000-0000-00000000bbbb",
        ] {
