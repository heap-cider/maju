...
import 'package:maju/features/profile/profile_edit_page.dart';
import 'package:maju/features/profile/profile_avatar_draft.dart';
import 'package:maju/features/profile/profile_avatar_crop_page.dart';
import 'package:maju/features/profile/avatar_background_grid.dart';
import 'package:maju/features/profile/avatar_editor_option_button.dart';
import 'package:maju/features/profile/animated_avatar_capture.dart';
import 'package:maju/features/profile/emoji_avatar_tile.dart';
import 'package:maju/features/profile/image_avatar_capture.dart';
import 'package:maju/shared/widgets/immediate_page_route.dart';
import 'package:maju/features/profile/profile_provider.dart';
import 'package:maju/shared/emoji/emoji_avatar.dart';
import 'package:maju/shared/emoji/emoji_data.dart';
import 'package:maju/shared/emoji/emoji_data_provider.dart';
import 'package:maju/shared/emoji/native_emoji_glyph.dart';
...
import 'package:maju/shared/widgets/ios_native_segmented_control.dart';
import 'package:maju/shared/widgets/ios_glass_navigation_button.dart';
import 'package:maju/shared/widgets/playing_avatar_image.dart';
import 'package:maju/shared/widgets/progressive_animated_avatar.dart';
...
void main() {
  ...
  testWidgets('uses the native profile text form on iOS', (tester) async {
    debugDefaultTargetPlatformOverride = TargetPlatform.iOS;
    const channel = MethodChannel('maju/profile_text_editor');
  ...
  testWidgets('shows profile fields and saves each one from a sheet', (
    ...
    expect(find.text('Building Maju'), findsOneWidget);
  ...
  testWidgets('keeps the local animation visible after profile Save', (
    ...
    expect(notifier.savedAvatarUrls.single, contains('#maju-anim='));
  });
