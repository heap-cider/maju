...
import 'package:maju/features/channels/channel.dart';
...
import 'package:maju/features/channels/voice_note_attachment.dart';
import 'package:maju/features/channels/voice_note_waveform.dart';
import 'package:maju/features/channels/voice_note_recording.dart';
import 'package:maju/shared/deeplink/deep_link.dart';
import 'package:maju/shared/deeplink/pending_deep_link_provider.dart';
import 'package:maju/shared/emoji/emoji_only.dart';
import 'package:maju/shared/relay/relay.dart';
import 'package:maju/shared/theme/theme.dart';
import 'package:maju/shared/widgets/maju_loading_indicator.dart';
...
void main() {
  ...
  group('MessageContent', () {
    ...
    group('inline formatting', () {
      ...
      testWidgets('renders and routes a maju message link', (tester) async {
        const url =
            'maju://message?channel=580ca78b-9dae-46f3-8854-bd671853ba32&id=bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb&thread=dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd';
      ...
      testWidgets('renders and routes bare Maju message links', (tester) async {
        const url =
        ...
        expect(find.byKey(ValueKey('maju-link-chip:$url')), findsOneWidget);
        await tester.tap(find.byKey(ValueKey('maju-link-chip:$url')));
        await tester.pump();
      ...
      testWidgets('keeps Markdown delimiters outside bare Maju links', (
        tester,
      ) async {
        const url =
            'maju://message?channel=580ca78b-9dae-46f3-8854-bd671853ba32&id=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';
        ...
        expect(find.byKey(ValueKey('maju-link-chip:$url')), findsNWidgets(2));

        await tester.tap(find.byKey(ValueKey('maju-link-chip:$url')).first);
        await tester.pump();
        final container = ProviderScope.containerOf(
          tester.element(find.byType(MessageContent)),
        );
      ...
      testWidgets('keeps non-adjacent Markdown delimiters outside links', (
        ...
        expect(find.byKey(ValueKey('maju-link-chip:$url')), findsNWidgets(4));
        final container = ProviderScope.containerOf(
          tester.element(find.byType(MessageContent)),
        );
        for (final link
            in find.byKey(ValueKey('maju-link-chip:$url')).evaluate()) {
      ...
      testWidgets('excludes sentence punctuation from bare Maju links', (
        tester,
      ) async {
        const messageUrl =
            'maju://message?channel=580ca78b-9dae-46f3-8854-bd671853ba32&id=aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa';
        const joinUrl =
            'maju://join?relay=wss%3A%2F%2Frelay.example.com&code=invite-1';
        ...
        expect(
          find.byKey(ValueKey('maju-link-chip:$messageUrl')),
          findsOneWidget,
        );
        expect(find.text(joinUrl), findsOneWidget);
        expect(_allRichText(tester), contains('See \u{FFFC}. Then \u{FFFC}!'));

        await tester.tap(find.byKey(ValueKey('maju-link-chip:$messageUrl')));
        await tester.pump();
        final container = ProviderScope.containerOf(
          tester.element(find.byType(MessageContent)),
        );
      ...
      testWidgets('renders and routes autolinked Maju thread links', (
        tester,
      ) async {
        const url =
            'maju://message?channel=580ca78b-9dae-46f3-8854-bd671853ba32&id=cccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc&thread=dddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd';
      ...
      testWidgets('renders and routes bare Maju join links', (tester) async {
        const url =
            'maju://join?relay=wss%3A%2F%2Frelay.example.com&code=invite-1';
      ...
      testWidgets('renders and routes bare Maju channel links', (tester) async {
        const url = 'maju://channel/580ca78b-9dae-46f3-8854-bd671853ba32';
      ...
      testWidgets('renders and routes labeled Maju channel links', (
        tester,
      ) async {
        const url = 'maju://channel/580ca78b-9dae-46f3-8854-bd671853ba32';
      ...
      testWidgets('routes rendered Maju channel links through callback', (
        tester,
      ) async {
        const channelId = '580ca78b-9dae-46f3-8854-bd671853ba32';
        const url = 'maju://channel/$channelId';
      ...
      testWidgets('renders and routes autolinked Maju channel links', (
        tester,
      ) async {
        const url = 'maju://channel/580ca78b-9dae-46f3-8854-bd671853ba32';
      ...
      testWidgets('leaves malformed Maju channel forms as plain text', (
        tester,
      ) async {
        const url =
            'maju://channel?channel=580ca78b-9dae-46f3-8854-bd671853ba32';
    ...
    group('media attachments', () {
      testWidgets('uses the shared Maju loader while a voice note loads', (
        tester,
      ) async {
        ...
        expect(find.byType(MajuLoadingIndicator), findsOneWidget);
...
''',
    ...
    group('Maju permalink chips', () {
      testWidgets('keeps authored Maju labels as ordinary links', (
        tester,
      ) async {
        final owner = 'ab' * 32;
        final id = 'cd' * 32;
        const channelId = '580ca78b-9dae-46f3-8854-bd671853ba32';
        final links = {
          'Open message': 'maju://message?channel=$channelId&id=$id',
          'Open channel': 'maju://channel/$channelId',
          'Release candidate': 'maju://pr?id=$id&owner=$owner&d=maju',
        };
        ...
        for (final entry in links.entries) {
          expect(
            find.byKey(ValueKey('maju-link-chip:${entry.value}')),
            findsNothing,
          );
      ...
      testWidgets('preserves formatting in authored Maju labels', (
        tester,
      ) async {
        const channelId = '580ca78b-9dae-46f3-8854-bd671853ba32';
        await tester.pumpWidget(
          _testable(
            const MessageContent(
              content: '[**design discussion**](maju://channel/$channelId)',
            ),
          ),
        );
        await tester.pump();
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          const channelId = '580ca78b-9dae-46f3-8854-bd671853ba32';
          final urls = [
            'maju://message?channel=$channelId&id=$id',
          ...
          expect(find.text('maju · cdcdcdcd'), findsNWidgets(2));
          ...
          expect(
            find.bySemanticsLabel('Pull request cdcdcdcd in repository maju'),
            findsOneWidget,
          );
          for (final url in urls.skip(2)) {
            final chipKey = ValueKey('maju-link-chip:$url');
      ...
      testWidgets('uses shortened channel identifiers when names are missing', (
        ...
        final id = 'cd' * 32;
        const channelId = '580ca78b-9dae-46f3-8854-bd671853ba32';
        final messageUrl = 'maju://message?channel=$channelId&id=$id';
        const channelUrl = 'maju://channel/$channelId';
