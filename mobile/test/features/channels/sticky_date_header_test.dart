...
import 'package:maju/features/channels/sticky_date_header.dart';
...
void main() {
  testWidgets(
    ...
    (tester) async {
      ...
      const channel = MethodChannel('maju/sticky_date_glass/42');
      ...
      try {
        ...
        expect(nativeView.viewType, 'maju/sticky_date_glass');
