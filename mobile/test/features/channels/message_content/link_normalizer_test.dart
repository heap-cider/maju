import 'package:maju/features/channels/message_content/link_normalizer.dart';
import 'package:flutter_test/flutter_test.dart';

void main() {
  const url = 'maju://message?channel=channel-1&id=message-1';

  test('normalizes supported bare and autolinked Maju URLs', () {
    expect(
  ...
  test('normalizes every bare Maju entity permalink family', () {
    final owner = 'ab' * 32;
    final id = 'cd' * 32;
    final links = [
