...
import 'package:maju/features/channels/agent_activity/observer_models.dart';
import 'package:maju/features/channels/agent_activity/transcript_builder.dart';
...
void main() {
  ...
  test('normalizes maju tool calls and applies result updates', () {
    final items = buildTranscript([
      _updateFrame(
        seq: 1,
        update: {
    ...
    expect(tool.majuToolName, 'send_message');
  ...
  test('parses maju prompt text into user message and metadata', () {
    final items = buildTranscript([
      ObserverFrame(
        seq: 1,
