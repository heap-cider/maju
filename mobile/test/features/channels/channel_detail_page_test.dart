...
import 'package:maju/features/channels/channel_messages_provider.dart';
import 'package:maju/features/channels/channel_mutes/channel_mutes_provider.dart';
import 'package:maju/features/channels/channel_mutes/channel_mutes_storage.dart';
import 'package:maju/features/channels/channel_stars/channel_stars_provider.dart';
import 'package:maju/features/channels/channel_stars/channel_stars_storage.dart';
import 'package:maju/features/channels/channel_typing_provider.dart';
import 'package:maju/features/channels/members_sheet.dart';
import 'package:maju/features/channels/composer_dock_size_reporter.dart';
import 'package:maju/features/channels/date_formatters.dart';
import 'package:maju/features/channels/day_divider.dart';
import 'package:maju/features/channels/emoji_picker.dart';
import 'package:maju/features/channels/ime_metrics_settle_observer.dart';
import 'package:maju/features/channels/local_message_send_animation_provider.dart';
import 'package:maju/features/channels/message_action_backdrop_state.dart';
import 'package:maju/features/channels/message_actions.dart';
import 'package:maju/features/channels/mobile_huddle_controller.dart';
import 'package:maju/features/channels/reaction_row.dart';
import 'package:maju/features/channels/thread_detail_page.dart';
import 'package:maju/features/channels/thread_replies_provider.dart';
...
import 'package:maju/features/channels/unread_badge/observed_unread_event.dart';
import 'package:maju/features/channels/small_avatar.dart';
...
import 'package:maju/features/profile/user_profile_sheet.dart';
import 'package:maju/shared/community/community_provider.dart';
import 'package:maju/shared/emoji/emoji_burst.dart';
import 'package:maju/shared/mentions/agent_identity_provider.dart';
import 'package:maju/shared/huddle/huddle.dart';
import 'package:maju/shared/relay/relay.dart';
import 'package:maju/shared/theme/theme.dart';
import 'package:maju/shared/widgets/app_list_card.dart';
import 'package:maju/shared/widgets/avatar_image.dart';
import 'package:maju/shared/widgets/frosted_app_bar.dart';
import 'package:maju/shared/widgets/frosted_scaffold.dart';
import 'package:maju/shared/widgets/flapping_bee.dart';
import 'package:maju/shared/widgets/keyboard_dismiss_on_drag.dart';
import 'package:maju/shared/widgets/ios_glass_navigation_button.dart';
import 'package:maju/shared/widgets/lucide_star_icon.dart';
import 'package:maju/shared/widgets/masked_avatar_badge.dart';
import 'package:maju/shared/widgets/skeleton.dart';
...
void main() {
  ...
  group('App bar', () {
    ...
    testWidgets('matches the channel header placement on iOS', (tester) async {
      debugDefaultTargetPlatformOverride = TargetPlatform.iOS;
      addTearDown(() => debugDefaultTargetPlatformOverride = null);
      const nativeChannel = MethodChannel('maju/navigation_glass/43');
      tester.binding.defaultBinaryMessenger.setMockMethodCallHandler(
        nativeChannel,
        (_) async => null,
      );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(nativeView.viewType, 'maju/navigation_glass');
        expect(
  ...
  group('Channel links', () {
    ...
    testWidgets('iOS composer focus and Latest fully reveal the final reply', (
      ...
      await tester.pump();
      const nativeChannel = MethodChannel('maju/jump_to_latest_glass/42');
      await tester.binding.defaultBinaryMessenger.handlePlatformMessage(
        nativeChannel.name,
        nativeChannel.codec.encodeMethodCall(const MethodCall('pressed')),
        (_) {},
