...
import 'package:maju/features/channels/channel_sections/channel_sections_provider.dart';
import 'package:maju/features/channels/channel_sections/channel_sections_storage.dart';
import 'package:maju/features/channels/channels_page.dart';
...
import 'package:maju/shared/community/community_icon_provider.dart';
...
void main() {
  ...
  testWidgets('keeps the Maju background fixed behind the channels list', (
    tester,
  ) async {
    await tester.pumpWidget(
      buildTestable(
  ...
  testWidgets('browse action exposes retry when refresh supersedes loading', (
    ...
    expect(find.byType(MajuLoadingIndicator), findsNothing);
    expect(find.text('Couldn’t load open channels.'), findsOneWidget);
    expect(find.byKey(const Key('browse-channels-retry')), findsOneWidget);
