...
import 'package:maju/features/pairing/pairing_crypto.dart';
...
import 'package:maju/shared/crypto/ecdh.dart';
    ...
    group('desktop identity recovery', () {
      ...
      setUp(() async {
        ...
        recoveryCode =
            'nostrpair://${source.public}'
            '?secret=$sessionSecretHex'
            '&relay=wss%3A%2F%2Fpairing.maju.xyz&v=1&mode=recover';
        authorizer = _FakeSensitiveActionAuthorizer();
