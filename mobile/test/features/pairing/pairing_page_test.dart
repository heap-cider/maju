...
import 'package:maju/features/pairing/pairing_page.dart';
import 'package:maju/features/pairing/pairing_provider.dart';
import 'package:maju/shared/community/community.dart';
import 'package:maju/shared/security/sensitive_action_authorizer.dart';
...
import 'package:maju/shared/widgets/tappable_flapping_bee.dart';
...
void main() {
  group('PairingPage', () {
    testWidgets('renders branding and progressive pairing actions', (
      ...
      expect(find.text('Welcome to Maju'), findsOneWidget);
    ...
    testWidgets('uses the onboarding surface for dark-theme SAS verification', (
      ...
      expect(
        find.text(
          'Make sure the six-digit code matches on both devices. Your Maju identity will transfer to this device. Only continue if you started this pairing from your desktop.',
        ),
        findsOneWidget,
      );
    ...
    testWidgets('recovery SAS puts permanent desktop access in the subtitle', (
      ...
      expect(find.textContaining('full Maju identity'), findsOneWidget);
    ...
    testWidgets('keeps SAS actions above the keyboard on small screens', (
      ...
      expect(
        find.textContaining('Maju identity will transfer'),
        findsOneWidget,
      );
      expect(find.text('Codes match'), findsOneWidget);
    });
