...
void main() {
  group('Maju theme catalog entries', () {
    ...
    test('forces neutral rendering without changing the stored accent', () {
      ...
      expect(
        effectiveAccentIndex(majuThemeName, storedAccent),
        neutralAccentIndex,
      );
      expect(
        effectiveAccentIndex(majuDarkThemeName, storedAccent),
        neutralAccentIndex,
      );
      expect(
  ...
  group('theme threading', () {
    ...
    testWidgets('Maju section labels use 80% neutral foreground', (
      tester,
    ) async {
      await tester.pumpWidget(
        harness(
    ...
    testWidgets('navigation roles inherit non-Maju theme tokens', (
      tester,
    ) async {
