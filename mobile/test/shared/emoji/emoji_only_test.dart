...
const _customEmoji = [
  CustomEmoji(shortcode: 'maju', url: 'https://example.test/maju.png'),
];
...
void main() {
  group('isEmojiOnlyMessage', () {
    ...
    test('counts a known custom shortcode as emoji', () {
      expect(emojiOnly(':maju:', customEmoji: _customEmoji), isTrue);
      expect(emojiOnly(':maju: \u{1F600}', customEmoji: _customEmoji), isTrue);
      expect(emojiOnly('hi :maju:', customEmoji: _customEmoji), isFalse);
    });
