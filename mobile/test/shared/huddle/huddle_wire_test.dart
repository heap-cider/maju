...
import 'package:maju/shared/huddle/huddle_auth.dart';
import 'package:maju/shared/huddle/huddle_wire.dart';
  ...
  group('HuddleAuthV2', () {
    test('uses the base relay URL and fixed v2 auth envelope', () {
      final parameters = HuddleConnectionParameters(
        relayWebSocketUrl: 'wss://maju.example',
        nsec: _privateKey,
      ...
      expect(tags[0], ['relay', 'wss://maju.example']);
      expect(tags[1], ['challenge', 'relay-challenge']);
      expect(
        parameters.audioWebSocketUri.toString(),
        'wss://maju.example/huddle/$_ephemeralChannelId/audio',
      );
      expect(
