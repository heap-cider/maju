...
import 'package:maju/shared/push/push_subscription_provider.dart';
...
void main() {
  ...
  test(
    ...
    () {
      ...
      final subscriptions = desiredMajuPushSubscriptions(
      ...
      expect(subscriptions.single.ignore.first.kinds, majuPushRenderableKinds);
