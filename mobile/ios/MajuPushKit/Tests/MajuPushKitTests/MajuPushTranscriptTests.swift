...
/// (`crates/maju-push-gateway/tests/vectors/app_attest_transcripts.json`)
...
final class MajuPushTranscriptTests: XCTestCase {
    // MARK: Fixture
    ...
    func testEnrollVector() throws {
        try assertMatchesVector("enroll", MajuPushTranscript.enroll(
    ...
    func testDelegateVector() throws {
        try assertMatchesVector("delegate", MajuPushTranscript.delegate(
            challengeId: Self.challengeId,
            challenge: Self.challenge,
    ...
    func testRotateEndpointVector() throws {
        try assertMatchesVector("rotate_endpoint", MajuPushTranscript.rotateEndpoint(
            challengeId: Self.challengeId,
            challenge: Self.challenge,
            installationHandle: Self.installationHandle,
            endpointEpoch: 1,
    ...
    func testRevokeDelegationVector() throws {
        try assertMatchesVector("revoke_delegation", MajuPushTranscript.revokeDelegation(
            challengeId: Self.challengeId,
            challenge: Self.challenge,
            installationHandle: Self.installationHandle,
            relayPubkey: Self.relayPubkey,
    ...
    func testRevokeInstallationVector() throws {
        try assertMatchesVector("revoke_installation", MajuPushTranscript.revokeInstallation(
            challengeId: Self.challengeId,
            challenge: Self.challenge,
            installationHandle: Self.installationHandle,
            endpointEpoch: 1,
    ...
    func testSolidusIsNotEscaped() throws {
        ...
        XCTAssertEqual(try MajuPushTranscript.CanonicalObject.escape("https://push.buzz.xyz/v1", field: "audience"),
                       "https://push.buzz.xyz/v1")
    }

    func testMinimalEscaping() throws {
        XCTAssertEqual(try MajuPushTranscript.CanonicalObject.escape("a\"b\\c\u{08}\u{09}\u{0A}\u{0C}\u{0D}\u{01}", field: "x"),
                       "a\\\"b\\\\c\\b\\t\\n\\f\\r\\u0001")
    }

    func testNonASCIIRejected() {
        XCTAssertThrowsError(try MajuPushTranscript.CanonicalObject.escape("caf\u{00E9}", field: "app_profile")) {
            XCTAssertEqual($0 as? MajuPushTranscriptError, .nonASCIIInput(field: "app_profile"))
        }
    }

    func testUUIDLowercased() throws {
        var o = MajuPushTranscript.CanonicalObject()
