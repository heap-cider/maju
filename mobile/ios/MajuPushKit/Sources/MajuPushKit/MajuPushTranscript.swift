...
public enum MajuPushTranscriptError: Error, Equatable {
...
///
/// Ground truth: `crates/maju-push-gateway/tests/vectors/app_attest_transcripts.json`,
...
public enum MajuPushTranscript {
    // MARK: Domains
    ...
    struct CanonicalObject {
        ...
        static func escape(_ s: String, field: String) throws -> String {
            ...
            for scalar in s.unicodeScalars {
                ...
                default: throw MajuPushTranscriptError.nonASCIIInput(field: field)
                }
            }
            return out
        }
