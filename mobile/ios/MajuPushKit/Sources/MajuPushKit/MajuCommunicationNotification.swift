...
public struct MajuCommunicationNotificationDescriptor: Equatable, Sendable {
  ...
  public init?(resolution: MajuPushResolution) {
    ...
    self.init(
      ...
      senderIdentifier: MajuPushPresentationIdentity.sender(
  ...
  public final class MajuCommunicationNotificationPresenter {
    ...
    public func present(
      ...
      resolution: MajuPushResolution,
      completion: @escaping (UNNotificationContent) -> Void
    ) {
      guard let descriptor = MajuCommunicationNotificationDescriptor(resolution: resolution) else {
    ...
    public static func makeIntent(
      _ descriptor: MajuCommunicationNotificationDescriptor
    ) -> INSendMessageIntent {
      ...
      if descriptor.conversationDisplayName != nil {
        ...
        if let senderAvatar {
          ...
          // Maju channels do not have a separate avatar, so use the verified
