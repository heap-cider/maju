...
enum VoiceNotePackager {
    ...
    private static func makeVoiceNoteVideoTrack(
        ...
        do {
            ...
            let queue = DispatchQueue(label: "xyz.block.maju.voice-note-envelope")
            var completed = false
    ...
    private static func exportVoiceNoteEnvelope(
        ...
        let completionQueue = DispatchQueue(label: "xyz.block.maju.voice-note-export")
