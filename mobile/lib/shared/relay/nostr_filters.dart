...
/// `crates/maju-relay/src/handlers/req.rs`. A subscription over more channels
/// than this must be split into multiple REQs, each within the cap.
const int kMaxExplicitChannelValues = 128;

/// Canonical [NostrFilter] constructors for common Maju queries.
///
...
abstract final class NostrFilters {
  ...
  ///
  /// `search_mode: "prefix"` is a Maju bridge-only extension: every caller is
