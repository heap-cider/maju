...
abstract final class EventKind {
  ...
  static const channelEventKinds = [
    deletion, // 5
    reaction, // 7
    nip29DeleteEvent, // 9005 — Maju-native deletion
...
class NostrFilter {
  ...
  /// Maju relay bridge filter extensions (for example NIP-CW `top_level`).
...
/// Parse a Maju command response from the relay's OK message content.
///
