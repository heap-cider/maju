...
class CommunityThemeStorage {
  static const _prefix = 'maju-community-theme.v1';
  static const _outboxPrefix = 'maju-community-theme-outbox.v1';
  static const _migrationPrefix = 'maju-community-theme-migrated.v1';
  static const _legacyModeKey = 'maju_theme_mode';
  static const _legacyAccentKey = 'maju_accent_color';
  static const _legacySchemeKey = 'maju_color_scheme';
  ...
  CommunityThemePreference legacyPreference() {
    ...
    final theme = findTheme(storedTheme ?? 'maju')?.name ?? 'maju';
