...
///
/// Maju leads the map the way it leads desktop's, so the first-party pair sorts
...
/// [themeCatalog] grouped for the appearance picker. Maju is always first;
...
ThemeGroups themeGroups() {
  ...
  int byPickerOrder(ThemeColors a, ThemeColors b) {
    final aIsMaju = isMajuTheme(a.name);
    final bIsMaju = isMajuTheme(b.name);
    if (aIsMaju != bIsMaju) return aIsMaju ? -1 : 1;
