...
import 'maju_theme.dart';
import 'color_scheme.dart';
import 'theme_catalog.dart';
import 'theme_pairs.dart';

const _themeModeKey = 'maju_theme_mode';
const _accentKey = 'maju_accent_color';
const _schemeKey = 'maju_color_scheme';

/// Maju ships as the default: the first-party pair, so a fresh install gets the
/// branded top-section gradient without picking a theme first.
const defaultSchemeName = majuThemeName;
const defaultSchemeDisplayName = 'Maju';
