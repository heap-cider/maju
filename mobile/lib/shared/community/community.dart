...
class Community {
  ...
  final MajuPushLeaseSubscriptionState pushSubscriptionState;
  ...
  const Community({
    ...
    this.pushSubscriptionState = const MajuPushLeaseSubscriptionState.desired(),
  ...
  Community copyWith({
    ...
    MajuPushLeaseSubscriptionState? pushSubscriptionState,
