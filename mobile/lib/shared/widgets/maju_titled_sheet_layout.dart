...
class MajuTitledSheetLayout extends HookWidget {
  const MajuTitledSheetLayout({
    super.key,
    required this.title,
    required this.child,
    this.leading,
  ...
  Widget build(BuildContext context) {
    ...
    final sheet = SizedBox(
      ...
      child: ColoredBox(
        key: const ValueKey('maju-sheet-surface'),
        color: paintsSurface ? color : Colors.transparent,
        child: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            DecoratedBox(
              key: const ValueKey('maju-sheet-scroll-divider'),
    ...
    return ClipRRect(
      key: const ValueKey('maju-sheet-surface-clip'),
