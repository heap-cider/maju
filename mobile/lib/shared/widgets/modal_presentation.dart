...
const majuModalAnimationStyle = AnimationStyle(
...
/// Shows a bottom sheet with Maju's shared motion and sheet chrome.
///
...
Future<T?> showMajuModalBottomSheet<T>({
  ...
  return showModalBottomSheet<T>(
    ...
    sheetAnimationStyle: reduceMotion
        ...
        : (sheetAnimationStyle ?? majuModalAnimationStyle),
...
/// Shows a dialog with Maju's shared motion, respecting reduced-motion settings.
Future<T?> showMajuDialog<T>({
  required BuildContext context,
  required WidgetBuilder builder,
  ...
  return showDialog<T>(
    ...
    animationStyle: reduceMotion
        ? AnimationStyle.noAnimation
        : (animationStyle ?? majuModalAnimationStyle),
  );
}
