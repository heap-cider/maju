...
/// Height of an idle [MajuSearchField].
const double majuSearchIdleFieldHeight = 45;

/// Font size used for idle [MajuSearchField] text.
const double majuSearchIdleTextSize = 15;
...
/// Maju's global-search text field treatment, shared by search-like inputs.
class MajuSearchField extends StatelessWidget {
  /// Creates a search field with Maju's shared styling.
  const MajuSearchField({
              ...
              child: TextField(
                ...
                decoration: InputDecoration(
                  ...
                  hintStyle: searchInputTextStyle.copyWith(
                    ...
                    fontSize: majuSearchIdleTextSize,
                    height: 20 / majuSearchIdleTextSize,
                  ),
