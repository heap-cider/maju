...
const _pushPresentationChannel = MethodChannel('maju/push');
...
Future<void> cacheMajuPushProfileEvents(
  String communityID,
...
Future<void> cacheMajuPushChannelEvents(
  String? communityID,
...
Future<void> cacheMajuPushAvatarFromLoadedBytes(
  String communityID,
  String sourceURL,
