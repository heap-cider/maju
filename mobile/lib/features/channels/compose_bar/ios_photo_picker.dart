...
const _inlinePhotoPickerViewType = 'maju/inline_photo_picker';
const _inlinePhotoPickerSupportChannel = MethodChannel(
  'maju/inline_photo_picker',
);
          ...
          UiKitView(
            ...
            onPlatformViewCreated: (viewId) {
              pickerChannel.value = MethodChannel(
                'maju/inline_photo_picker/$viewId',
              );
            },
          ),
...
class _NativePhotoPickerLoading extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SizedBox(
      ...
      width: double.infinity,
      child: const Center(
        child: MajuLoadingIndicator(size: 44, semanticLabel: 'Opening Photos'),
      ),
    );
  }
}
