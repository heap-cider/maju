...
String channelSortKey(String pubkey, String relayUrl) =>
    'maju.channel-sort.v1:$pubkey:${Uri.encodeComponent(normalizeChannelSortRelayUrl(relayUrl))}';

String legacyChannelSortKey(String pubkey) => 'maju.channel-sort.v1:$pubkey';
