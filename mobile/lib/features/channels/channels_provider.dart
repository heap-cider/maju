...
const _participatedRootIdsPrefix = 'maju-thread-participation.v1';
const _authoredRootIdsPrefix = 'maju-thread-authored.v1';
...
class ChannelsNotifier extends AsyncNotifier<List<Channel>> {
  ...
  Future<List<Channel>> _fetchChannels({
    ...
    unawaited(
      cacheMajuPushChannelEvents(communityID, dedupedMetas, [
        ...memberships,
        ...memberEvents,
      ]),
    );
