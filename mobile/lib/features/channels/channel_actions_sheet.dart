...
import '../../shared/widgets/maju_action_tile.dart';
...
Future<void> _confirmAndRun(
  ...
  final confirmed = await showMajuDialog<bool>(
    context: pageContext,
...
Future<void> _showMoveSectionSheet(
  ...
  await showMajuModalBottomSheet<void>(
    context: context,
    showDragHandle: true,
...
Future<String?> _showSectionNameDialog(BuildContext context) async {
  ...
  final result = await showMajuDialog<String>(
    context: context,
    builder: (dialogContext) => AlertDialog(
      title: const Text('New Section'),
