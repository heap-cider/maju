...
class _ThemePreviewExperience extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final supportsAccent = !isMajuTheme(selectedDisplayed.name);
...
class _ThemeDevicePairPreview extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final base = platformBrightness == Brightness.dark
        ? resolved.dark
        : resolved.light;
    final effectiveAccent = isMajuTheme(displayed.name)
        ? defaultAccentIndex
        : accentIndex;
    final scheme = applyAccent(base, effectiveAccent);
    final gradient = majuTopSectionGradient(displayed.name, scheme.brightness);
