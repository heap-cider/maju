...
Next to it, a "Connect on Maju" button.
...
You hit "Connect on Maju" and the app opens. You're in `#general`. The team is
...
"Connect on Maju" and they're in the community. No separate onboarding flow. No
...
portable even when the hosting isn't. And you can use Maju as a collaboration
layer on top of GitHub if that's what makes sense — work in Maju channels, push
...
Someone picks up the bug. They create a branch. Maju creates a channel:
...
things are announcements. Some things are essays. Maju has surfaces for both,
...
Onboarding friction is real — not insurmountable, but real. The "Connect on Maju"
