...
[[ "$repo" == "heap-cider/maju" ]] || fail "candidate publishing is restricted to heap-cider/maju"
...
message="Maju Mobile $version release candidate $candidate_number"
tag_object_sha="$(
...
printf 'Published %s at %s through maju-release-bot.\n' "$tag" "$target_sha"
