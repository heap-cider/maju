...
run_unit_tests() {
  ...
  run_test_step "maju-acp tests" \
    cargo test -p maju-acp -- --nocapture
  ...
  run_test_step "maju-relay channel authorization tests" \
    cargo test -p maju-relay --lib handlers::channel_authz:: -- --nocapture

  run_test_step "maju-relay moderation authorization tests" \
    cargo test -p maju-relay --lib handlers::moderation_authz:: -- --nocapture

  run_test_step "maju-relay side-effects helper tests" \
    cargo test -p maju-relay --lib handlers::side_effects::tests:: -- --nocapture
}
