...
# Installed Maju state is preserved.
# =============================================================================
set -euo pipefail
...
if [[ "${1:-}" != "--yes" ]]; then
  ...
  echo -e "   Installed Maju app state and its production keyring are preserved."
...
success "Desktop development state removed (installed Maju state preserved)"
