...
DB_HOST="${MAJU_DB_HOST:-127.0.0.1}"
DB_PORT="${MAJU_DB_PORT:-5432}"
DB_USER="${MAJU_DB_USER:-maju}"
DB_PASS="${MAJU_DB_PASS:-maju_dev}"
DB_NAME="${MAJU_DB_NAME:-maju}"
DB_DOCKER_CONTAINER="${MAJU_DB_DOCKER_CONTAINER:-maju-postgres}"
...
COMMUNITY_HOST="${MAJU_COMMUNITY_HOST:-localhost:3000}"
...
UUID_GENERAL=$(uuid5_hex "maju.channel.general")
UUID_RANDOM=$(uuid5_hex "maju.channel.random")
UUID_ENGINEERING=$(uuid5_hex "maju.channel.engineering")
UUID_AGENTS=$(uuid5_hex "maju.channel.agents")
UUID_WATERCOOLER=$(uuid5_hex "maju.channel.watercooler")
UUID_ANNOUNCEMENTS=$(uuid5_hex "maju.channel.announcements")
UUID_DM_ALICE_TYLER=$(uuid5_hex "maju.channel.dm.alice-tyler")
UUID_DM_BOB_TYLER=$(uuid5_hex "maju.channel.dm.bob-tyler")
UUID_DM_BOB_CHARLIE_TYLER=$(uuid5_hex "maju.channel.dm.bob-charlie-tyler")
