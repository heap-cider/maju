...
: "${MAJU_POSTGRES_ADMIN_URL:?setup must provide MAJU_POSTGRES_ADMIN_URL}"
: "${MAJU_POSTGRES_DESIRED_TEMPLATE:?setup must provide MAJU_POSTGRES_DESIRED_TEMPLATE}"
...
database="maju_nt_${database_hash}"
schema_mode="desired"
source_database="$MAJU_POSTGRES_DESIRED_TEMPLATE"
...
database_url="${MAJU_POSTGRES_ADMIN_URL%/*}/$database"
export DATABASE_URL="$database_url"
export TEST_DATABASE_URL="$database_url"
export MAJU_TEST_DATABASE_URL="$database_url"
export MAJU_TEST_SCHEMA_MODE="$schema_mode"
